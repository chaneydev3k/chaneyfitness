...
/**
 * Pill linking out to the Google Business Profile reviews. Styled for a
 * dark surface (the Results section).
 */
export function GoogleReviewsBadge({ className }: { className?: string }) {
  return (
    <a
      ...
      className={cn(
        "group inline-flex items-center gap-2.5 rounded-full border border-white/15 bg-white/[0.04] px-4 py-2 text-sm transition-colors hover:border-white/40 hover:bg-white/[0.08]",
        className
      )}
    >
